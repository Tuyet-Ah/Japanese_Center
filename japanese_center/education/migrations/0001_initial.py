...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='japanese_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.japaneseclass'),
        ),
        migrations.CreateModel(
            name='Lesson',
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to='lessons/files/', verbose_name='Tài liệu đính kèm')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
