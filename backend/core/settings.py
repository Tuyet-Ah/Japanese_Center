...
SECRET_KEY = 'django-insecure-f81lm+x7pg%z@x-wn)-_*&7^=n%6x!_1$lz(dcbb2rpqd(*u9n'
...
STATIC_URL = 'static/'
# Serve các file tĩnh của Frontend (CSS, JS, assets) qua Django khi cần
...
SIMPLE_JWT = {
    # Thời gian Access Token có hiệu lực (thường để ngắn để bảo mật)
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), 
    
    # Thời gian Refresh Token có hiệu lực (dùng để lấy Access Token mới)
